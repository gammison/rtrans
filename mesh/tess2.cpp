...
typedef Tess::Vertex_handle vertexHandle; //stores vertices
...
int Tess2d::extrGeom(
    ...
    // only process local particle information, only currently doing one region so it is also the total particle number
    for (int i=0; i<locNumParticles; i++) {
